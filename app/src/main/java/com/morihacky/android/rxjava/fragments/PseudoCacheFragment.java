...
public class PseudoCacheFragment extends BaseFragment {
  ...
  @OnClick(R.id.btn_pseudoCache_concat) public void onConcatBtnClicked() {
  ...
  @OnClick(R.id.btn_pseudoCache_concatEager) public void onConcatEagerBtnClicked() {
  ...
  @OnClick(R.id.btn_pseudoCache_merge) public void onMergeBtnClicked() {
  ...
  @OnClick(R.id.btn_pseudoCache_mergeSlowDisk) public void onMergeSlowBtnClicked() {
  ...
  @OnClick(R.id.btn_pseudoCache_mergeOptimized) public void onMergeOptimizedBtnClicked() {
  ...
  private void wireupDemo() {
    ...
    adapterDetail = new ArrayAdapter<>(getActivity(), R.layout.item_log_white, R.id.item_log,
        new ArrayList<>());
    listDetail.setAdapter(adapterDetail);

    adapterSubscriptionInfo =
        new ArrayAdapter<>(getActivity(), R.layout.item_log_white, R.id.item_log,
            new ArrayList<>());
